...
function onMovePlayer (data) {
  ...
  this.broadcast.emit('move player', {id: movePlayer.id, x: movePlayer.getX(), y: movePlayer.getY(), vx: movePlayer.getVX(), vy: movePlayer.getVY(), angle: movePlayer.getAngle()})
}
